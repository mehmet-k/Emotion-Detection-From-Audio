...
features = ["MFCC","RMS","CHROMA_VQT","CHROMA_STFT","MEL"]
...
# Train the model
history = model.fit(X_train, y_train, epochs=25, batch_size=1024, validation_split=0.3)
